...
function setPhonics(userInput){
    ...
    if (level_id == "Starter") {
        ...
        if (userInput == "Unit 1") {
            ...
            pArray = [({pattern:'a', value:'add'), ({pattern:'a', value:'apple'}), ({pattern:'a', value:'ant'}), ({pattern:'b', value:'ball'}), ({pattern:'b', value:'boy'}), ({pattern:'c', value:'cat'}), ({pattern:'c', value:'car'}), ({pattern:'d', value:'dog'}), ({pattern:'d', value:'desk'}), ({pattern:'e', value:'egg'}), ({pattern:'e', value:'elephant'}), ({pattern:'f', value:'fish'}), ({pattern:'f', value:'frog'}), ({pattern:'g', value:'goat'}), ({pattern:'g', value:'girl'}), ({pattern:'h', value:'hat'}), ({pattern:'h', value:'house'}), ({pattern:'i', value:'igloo'}), ({pattern:'I', value:'Indian'}), ({pattern:'j', value:'jar'}), ({pattern:'j', value:'jet'}), ({pattern:'k', value:'king'}), ({pattern:'k', value:'kite'}), ({pattern:'l', value:'lollipop'}), ({pattern:'l', value:'lion'})];

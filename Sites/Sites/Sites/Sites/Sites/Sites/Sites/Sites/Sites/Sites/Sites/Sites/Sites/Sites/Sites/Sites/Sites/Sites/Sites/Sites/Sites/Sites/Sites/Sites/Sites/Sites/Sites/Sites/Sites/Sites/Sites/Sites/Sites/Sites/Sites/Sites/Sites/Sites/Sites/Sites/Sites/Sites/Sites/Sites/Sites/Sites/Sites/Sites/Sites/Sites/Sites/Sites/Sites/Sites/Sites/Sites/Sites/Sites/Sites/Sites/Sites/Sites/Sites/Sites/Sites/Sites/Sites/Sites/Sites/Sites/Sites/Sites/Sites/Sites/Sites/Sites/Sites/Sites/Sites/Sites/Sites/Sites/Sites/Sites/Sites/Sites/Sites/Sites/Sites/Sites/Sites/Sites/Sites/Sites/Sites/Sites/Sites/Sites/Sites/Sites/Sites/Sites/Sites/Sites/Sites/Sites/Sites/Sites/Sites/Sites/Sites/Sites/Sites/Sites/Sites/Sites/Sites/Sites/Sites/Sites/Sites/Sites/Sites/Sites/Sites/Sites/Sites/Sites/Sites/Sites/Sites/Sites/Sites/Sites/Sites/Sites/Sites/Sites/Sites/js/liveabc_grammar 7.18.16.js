function setGrammar(userInput){
    ...
    if (level_id == "Starter") {
        ...
        if (userInput == "Unit 1") {
            ...
            document.getElementById("g0r1d0").innerHTML =  '<p>' + pronounArray[0] + '</p>';
            ...
            if(pronounArray[0] == "I ") {
                document.getElementById("grammarInputA").pattern = "am";
            } else if(pronounArray[0] == "You "){
                document.getElementById("grammarInputA").pattern = "are";
            } else {
                document.getElementById("grammarInputA").pattern = "blank";
            }
            gLinks = [''];
            grammarLesson = "";
        } else if (userInput == "Unit 2") {
            ...
            if (pronounArray[0] == "you" || pronounArray[0] == "they") {
                document.getElementById("g0r0d0").innerHTML = "How old are " + pronounArray[0] + "?";
                if (pronounArray[0] == "you") {
                    if (q1Array[0].number == "1") {
                        sampleAnswer = "I am " + q1Array[0].spelling + " year old.";
                    } else {
                        sampleAnswer = "I am " + q1Array[0].spelling + " years old.";
                    }
                } else {
                    if (q1Array[0].number == "1") {
                        sampleAnswer = "They are " + q1Array[0].spelling + " year old.";
                    } else {
                        sampleAnswer = "They are " + q1Array[0].spelling + " years old.";
                    }
                }
            } else {
                ...
                if (q1Array[0].number == "1") {
                    sampleAnswer = capitalized + " is " + q1Array[0].spelling + " year old.";
                } else {
                    sampleAnswer = capitalized + " is " + q1Array[0].spelling + " years old.";
                }
            }
        ...
        if (userInput == "Unit 1") {
            ...
            document.getElementById("g0r0d0").innerHTML = "Can " + pronounArray[0] + " " + verbArray[0] + "?";
            choiceArrayInt = 0;
            while(choiceArrayInt == 0) {choiceArrayInt = Math.floor(Math.random() * 3)};
            if (choiceArrayInt == 1) {
                document.getElementById("g0r0d5").innerHTML = '<h1 style="font-size:100px">&#x2705;</h1>';
            ...
            switch(verbArray[0].verb){
                    case "be":
                        if (pronounArray[0] == "I"){
                            ...
                            sampleAnswer = pronounArray[0] + " is " + q1Array[0].value + " busy.";
                        } else {
                            sampleAnswer = pronounArray[0] + " are " + q1Array[0].value + " busy.";
                        }
                        break;
                    case "have":
                        if (pronounArray[0] == "He" || pronounArray[0] == "She") {
                            sampleAnswer = pronounArray[0] + " " + q1Array[0].value + " has a snack.";
                        } else {
                            sampleAnswer = pronounArray[0] + " " + q1Array[0].value + " have a snack.";
                        }
                        break;
                    case "wash":
                        if (pronounArray[0] == "He" || pronounArray[0] == "She") {
                            sampleAnswer = pronounArray[0] + " " + q1Array[0].value + " washes the dishes.";
                        } else {
                            sampleAnswer = pronounArray[0] + " " + q1Array[0].value + " wash the dishes.";
                        }
                        break;
                    case "cry":
                        if (pronounArray[0] == "He" || pronounArray[0] == "She") {
                            sampleAnswer = pronounArray[0] + " " + q1Array[0].value + " cries.";
                        } else {
                            sampleAnswer = pronounArray[0] + " " + q1Array[0].value + " cry.";
                        }
                        break;
                case "study":
                    if (pronounArray[0] == "He" || pronounArray[0] == "She") {
                        sampleAnswer = pronounArray[0] + " " + q1Array[0].value + " studies.";
                    } else {
                        sampleAnswer = pronounArray[0] + " " + q1Array[0].value + " study.";
                    }
                    break;
                   default:
                        if (pronounArray[0] == "He" || pronounArray[0] == "She") {
                            sampleAnswer = pronounArray[0] + " " + q1Array[0].value + " " + verbArray[0].verb + "s" + verbArray[0].object + ".";
                        } else {
                            sampleAnswer = pronounArray[0] + " " + q1Array[0].value + " " + verbArray[0].verb + verbArray[0].object + ".";
                        }
                        break;
            }
